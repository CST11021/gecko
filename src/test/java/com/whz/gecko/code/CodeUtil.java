...
public class CodeUtil {
    ...
    public static byte[] objectToByteArray(Object obj) {
        ...
        try {
            ...
            throw new RuntimeException("objectToByteArray failed, " + e);
        } finally {
            if (objectOutputStream != null) {
                try {
                    objectOutputStream.close();
                } catch (IOException e) {
                    throw new RuntimeException("close objectOutputStream failed, " + e);
                }
            }
            if (byteArrayOutputStream != null) {
                try {
                    ...
                    throw new RuntimeException("close byteArrayOutputStream failed, " + e);
                }
            }
    ...
    public static Object byteArrayToObject(byte[] bytes) {
        ...
        try {
            ...
            throw new RuntimeException("byteArrayToObject failed, " + e);
        } finally {
            if (byteArrayInputStream != null) {
                try {
                    byteArrayInputStream.close();
                } catch (IOException e) {
                    throw new RuntimeException("close byteArrayInputStream failed, " + e);
                }
            }
            if (objectInputStream != null) {
                try {
                    ...
                    throw new RuntimeException("close objectInputStream failed, " + e);
                }
            }
        }
        return obj;
