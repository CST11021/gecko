...
/**
 * @author boyan
 * @since 1.0, 2009-12-24 下午03:09:42
 */
...
public class SelectorManagerUnitTest {
    ...
    public void testInsertTimer() throws Exception {
        ...
        this.selectorManager.insertTimer(new TimerRef(2000, new Runnable() {
    ...
    @Test
    public void testInsertMoreTimers() throws Exception {
        ...
        for (int i = 0; i < 100000; i++) {
            this.selectorManager.insertTimer(new TimerRef(2000, new Runnable() {
                ...
                public void run() {
                    ...
                    Assert.assertEquals(2000, duration, 500);
        ...
        System.out.println(System.currentTimeMillis() - start);
        Thread.sleep(5000);
        Assert.assertEquals(100000, count.get());
    }
