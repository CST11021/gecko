...
import com.taobao.gecko.service.callback.impl.GroupAllConnectionRequestCallBack;
import com.taobao.gecko.service.callback.impl.MultiGroupRequestCallBack;
import com.taobao.gecko.service.connection.*;
import com.taobao.gecko.service.connection.impl.InvalidCallBackScanTask;
import com.taobao.gecko.service.connection.impl.RoundRobinConnectionSelector;
import com.taobao.gecko.service.nio.SocketOption;
...
import com.taobao.gecko.service.handler.impl.GeckoHandler;
...
import com.taobao.gecko.service.callback.*;
...
public abstract class BaseRemotingController implements RemotingController {
    ...
    /** Map<group, Map<key, object>> */
    protected ConcurrentHashMap<String, ConcurrentHashMap<String, Object>> attributes = new ConcurrentHashMap<String, ConcurrentHashMap<String, Object>>();
    /** 选择连接策略：从分组的连接列表中选择想要的连接 */
    ...
    /**
     * 根据conf创建一个SocketChannelController实例，即用于通信的通道的控制器
     *
     * @param conf
     * @return
     */
    ...
    /**
     * 根据BaseConfig创建一个Configuration实例
     *
     * @param config
     * @return
     */
