...
import com.taobao.gecko.service.session.impl.NioUDPSession;
...
public abstract class DatagramChannelController extends NioController {
    ...
    protected void dispatchReadEvent(final SelectionKey key) {
        if (this.udpSession != null) {
            this.udpSession.onEvent(SessionEventType.READABLE, key.selector());
        } else {
    ...
    protected void dispatchWriteEvent(final SelectionKey key) {
        if (this.udpSession != null) {
            this.udpSession.onEvent(SessionEventType.WRITEABLE, key.selector());
        } else {
    ...
    protected void buildUDPSession() {
        ...
        this.selectorManager.registerSession(this.udpSession, SessionEventType.ENABLE_READ);
