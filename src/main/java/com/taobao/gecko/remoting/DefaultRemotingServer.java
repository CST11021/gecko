...
import com.taobao.gecko.service.connection.impl.InvalidConnectionScanTask;
...
import com.taobao.gecko.remoting.controller.server.TCPController;
...
public class DefaultRemotingServer extends BaseRemotingController implements RemotingServer {
    ...
    protected void doStart() throws NotifyRemotingException {
        ...
        if (!this.remotingContext.getProcessorMap().containsKey(HeartBeatRequestCommand.class)) {
