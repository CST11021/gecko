...
import com.taobao.gecko.remoting.RemotingContext;
import com.taobao.gecko.service.callback.SingleRequestCallBackListener;
import com.taobao.gecko.service.callback.RequestCallBack;
import com.taobao.gecko.service.callback.impl.SingleRequestCallBack;
...
public class DefaultConnection implements Connection {
    ...
    public void transferFrom(final IoBuffer head, final IoBuffer tail, final FileChannel channel, final long position, final long size, final Integer opaque, final SingleRequestCallBackListener listener, final long time, final TimeUnit unit) throws NotifyRemotingException {
        if (channel == null) {
    ...
    public void setAllowReconnect(final boolean allowReconnect) {
