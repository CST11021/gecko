 ...
 */
package com.taobao.gecko.service.connection;
...
public class ScanAllConnectionRunner implements Runnable {
    ...
    public void run() {
        ...
        final List<Connection> connections = this.controller.getRemotingContext().getConnectionsByGroup(Constants.DEFAULT_GROUP);
        if (connections != null) {
