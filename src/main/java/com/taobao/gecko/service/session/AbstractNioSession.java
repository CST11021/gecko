...
import com.taobao.gecko.service.nio.Reactor;
...
import com.taobao.gecko.core.message.impl.FileWriteMessage;
...
public abstract class AbstractNioSession extends AbstractSession implements NioSession {
    ...
    protected void addPoisonWriteMessage(final PoisonWriteMessage poisonWriteMessage) {
        ...
        this.selectorManager.registerSession(this, SessionEventType.ENABLE_WRITE);
    }
     ...
     */
    public final void onEvent(final SessionEventType event, final Selector selector) {
    ...
    protected void unregisterSession() {
        this.selectorManager.registerSession(this, SessionEventType.UNREGISTER);
    }
    ...
    protected final void registerSession() {
        this.selectorManager.registerSession(this, SessionEventType.REGISTER);
    }
