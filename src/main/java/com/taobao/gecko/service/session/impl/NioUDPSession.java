 ...
 */
package com.taobao.gecko.service.session.impl;

import com.taobao.gecko.core.buffer.IoBuffer;
import com.taobao.gecko.core.codec.ByteBufferCodecFactory;
import com.taobao.gecko.core.message.WriteMessage;
import com.taobao.gecko.service.config.NioSessionConfig;
import com.taobao.gecko.service.handler.impl.UDPHandlerAdapter;
import com.taobao.gecko.core.message.impl.ByteBufferWriteMessage;
...
import com.taobao.gecko.service.session.UDPSession;
import com.taobao.gecko.service.statistics.impl.DefaultStatistics;
...
public class NioUDPSession extends AbstractNioSession implements UDPSession {
    ...
    protected synchronized void readFromBuffer() {
        ...
        try {
            this.decode();
            this.selectorManager.registerSession(this, SessionEventType.ENABLE_READ);
