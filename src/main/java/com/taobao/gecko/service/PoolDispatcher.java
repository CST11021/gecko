...
public class PoolDispatcher implements Dispatcher {
    ...
    public PoolDispatcher(final int poolSize, final long keepAliveTime, final TimeUnit unit, final RejectedExecutionHandler rejectedExecutionHandler) {
    ...
    public PoolDispatcher(final int poolSize, final long keepAliveTime, final TimeUnit unit, final String prefix, final RejectedExecutionHandler rejectedExecutionHandler) {
        this.threadPool = new ThreadPoolExecutor(poolSize, (int) (MAX_POOL_SIZE_FACTOR * poolSize), keepAliveTime, unit,
